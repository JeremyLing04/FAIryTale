...
if __name__ == '__main__':
    ...
    print("="*60)
    print("Starting IMAGE server on http://0.0.0.0:5001")
    print("Test endpoint: http://localhost:5001/test")
    print()
    print("PORT CONFIGURATION:")
    print("- Ollama+Mistral: Port 11434 (default)")
    print("- SD15+IP-Adapter: Port 5001 (this server)")
    print()
    print("To expose to Replit:")
    print("1. Install ngrok: https://ngrok.com/download")
    print("2. Terminal 1: ngrok http 11434  # For Ollama")
    print("3. Terminal 2: ngrok http 5001   # For Images")
    print("4. Copy HTTPS URLs to Replit secrets:")
    print("   - OLLAMA_HOST=https://your-ollama.ngrok.io")
    print("   - REMOTE_IMAGE_URL=https://your-image.ngrok.io")
    print("="*60)
