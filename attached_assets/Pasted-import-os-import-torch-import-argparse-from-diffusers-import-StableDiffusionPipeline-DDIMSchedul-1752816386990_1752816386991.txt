...
parser.add_argument("--character", type=str, default="a anime style heroic silver-armored knight with a red cape, cinematic lighting", help="Character description to be used in story")
...
negative_prompt = None  # 可以改为 "blurry, low quality, deformed, watermark"
